...
# This script installs puppet 3.x and deploy the manifest using puppet apply -e "include profile_rsyslog"
# Usage:
# <powershell>
# Set-ExecutionPolicy Unrestricted -Force
# icm $executioncontext.InvokeCommand.NewScriptBlock((New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/relybv/profile_rsyslog/master/files/bootme.ps1')) -ArgumentList ("profile_rsyslog")
#</powershell>


  param(
    [string]$role = "profile_rsyslog",
  )

  $puppet_source = "https://github.com/relybv/dirict-profile_rsyslog.git"
